...
while True:
    user = api.get_user('SerenaDuggem')
    api.update_profile(name=f'Serena|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Serena|{follower_count(user)} Followers')
